...
namespace UserProfileDemo.UITests
{
    internal static class TestHelper
    {
        ...
        public static string UNIVERSITYSELECTBUTTON = "btnUniversitySelect";
        public static string NAMESEARCHBAR = "sbName";
        public static string COUNTRYSEARCHBAR = "sbCountry";
        public static string LOOKUPBUTTON = "btnLookup";
        public static string LOOKUP = "LOOKUP";
        public static string UNIVERSITYLISTVIEW = "lvItems";
    }
    ...
    internal static class TestData
    {
        ...
        public static string TESTUNIVERSITYSEARCHNAME = "Harvard";
        public static string TESTUNIVERSITYCSEARCHCOUNTRY = "United States";
    }
}